 ...
 *
 * @param BUTTON The name of the pushbutton to register the callback for. Use values from #pushBUTTON_t
 * enumeration.
 ...
 *
 * @param BUTTON The name of the pushbutton to register the release callback for. Use values from
 * #pushBUTTON_t enumeration.
 ...
 *
 * @param BUTTON The name of the pushbutton to register the callbacks for. Use values from #pushBUTTON_t
 * enumeration.
 ...
 *
 * @param BUTTON The name of the pushbutton to enable repetition for. Use values from #pushBUTTON_t
 * enumeration.
 *
 * @note If the pushbutton is not registered, this function has no effect.
 */
 ...
 *
 * @param BUTTON The name of the pushbutton to disable repetition for. Use values from #pushBUTTON_t
 * enumeration.
 *
 * @note If the pushbutton is not registered, this function has no effect.
 */
...
/**
 * @brief set selected trigger mode for initialized pushbutton.
 *
 * This function set pushbutton triger mode accordign to function arguments.
 *
 * @param BUTTON The name of the pushbutton to set trigger mode for. Use values from #pushBUTTON_t
 * enumeration.
 * @param mode_2_set The desired trigger mode to set for selected pushbutton. Use values from #PB_trigger_mode_t
 * enumeration.
 *
 * @note If the pushbutton is not registered, this function has no effect.
 */
void set_pushbuton_trigger_mode(PUSHBUTTON_TypDef *BUTTON, PB_trigger_mode_t mode_2_set)
{
    BUTTON->trigger_mode = mode_2_set;
}
 ...
 *
 * @param BUTTON The name of the pushbutton to decrement the timer for. Use values from #pushBUTTON_t
 * enumeration.
 *
