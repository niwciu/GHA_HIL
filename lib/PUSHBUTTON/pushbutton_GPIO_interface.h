...
#include <stdint.h>
     ...
     */
    const PB_driver_interface_t *pushbutton_DOWN_GPIO_interface_get(void);

    /**
     * @brief Gets the GPIO interface for pushbutton 3.
     *
     * This function returns a pointer to the GPIO driver interface structure
     * specific to pushbutton 3 on GPIO drier layer.
     *
     * @return Pointer to the pushbutton 3 GPIO interface.
     */
    const PB_driver_interface_t *pushbutton_ESC_GPIO_interface_get(void);

    /**
     * @brief Gets the GPIO interface for pushbutton 4.
     *
     * This function returns a pointer to the GPIO driver interface structure
     * specific to pushbutton 4 on GPIO drier layer.
     *
     * @return Pointer to the pushbutton 4 GPIO interface.
     */
    const PB_driver_interface_t *pushbutton_ENTER_GPIO_interface_get(void);

    /**
     * @brief Gets the GPIO interface for pushbutton 5.
     *
     * This function returns a pointer to the GPIO driver interface structure
     * specific to pushbutton 5 on GPIO drier layer.
     *
     * @return Pointer to the pushbutton 5 GPIO interface.
     */
