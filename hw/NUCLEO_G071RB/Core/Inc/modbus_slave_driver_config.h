...
#define MODBUS_SLAVE_USART_RX_AF (GPIO_AFRL_AFSEL3_1) // set specyfic AF for USART RX
#define MODBUS_SLAVE_USART_TX_AF (GPIO_AFRL_AFSEL2_1) // set specyfic AF for USART TX
#define MODBUS_SLAVE_USART_DE_AF (GPIO_AFRL_AFSEL1_1) // set specyfic AF for USART DE
